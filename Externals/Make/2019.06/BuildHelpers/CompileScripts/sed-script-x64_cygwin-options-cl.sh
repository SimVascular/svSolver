...
s+REPLACEME_SV_TOPLEVEL_BINDIR+C:/cygwin64/usr/local/svsolver/ext/2019.06/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/bin+g
s+REPLACEME_SV_SPECIAL_TOPLEVEL_BINDIR+C:\\cygwin64/usr/local/svsolver/ext/2019.06/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/bin+g
s+REPLACEME_NO_FIRST_SLASH_SV_TOPLEVEL_BINDIR+usr/local/svsolver/ext/2019.06/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/bin+g
#s+REPLACEME_SV_TOPLEVEL_BUILDDIR+C:/svsolver-ext-2019-06-gl1+g
#s+REPLACEME_SHORT_GL_NAME+gl1+g
s+REPLACEME_SV_TOPLEVEL_BUILDDIR+C:/svsolver-ext-2019-06-gl2+g
